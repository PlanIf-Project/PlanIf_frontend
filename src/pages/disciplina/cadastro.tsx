...
const CadastroDisciplina = (props: any) => {
    ...
    const cadastro = () => { 
       if(valid(nome)) {
           let obj = {nome: nome, descricao: descricao, idUsuario: localStorage.getItem('idUsuario')!};
         
           axios.post('http://localhost:4000/disciplinas/criarDisciplina', obj, { headers: {'x-access-token':localStorage.getItem('token')!}} )
           .then(response => {
