        ...
        <div className="page">
            <div className="box">
                ...
                <div>
                    ...
                    <input className="input" placeholder="Descrição" type="text" value={tarefa.descricao} onChange={(e)=> setTarefa({id: tarefa.id, nome: tarefa.nome, data: tarefa.data, descricao: e.target.value, feito:  tarefa.feito})}/>
